...
async function getSchema() {
  try {
    ...
    const tablesToCheck = ['stations', 'users', 'stationpayments', 'stationissues'];
    ...
    for (const table of tablesToCheck) {
      ...
      if (queryError) {
        ...
        // If no records, try to get columns via another way if possible, 
        // but at least we know it exists if error is null.
